...
_Examples live in the docs directory of the Github repo and can be found [here.](docs/examples)_
...
Cloudscraper exposes the following options that are required by default but might be changed. _Please note that the default values eliminate the chance of getting sent a CAPTCHA._
