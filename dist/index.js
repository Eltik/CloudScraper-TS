...
class CloudScraper {
    ...
    defaults(params) {
        let defaultParams = {
            ...
            headers: (0, headers_1.getDefaultHeaders)({ Host: this.HOST }),
        ...
        Object.defineProperty(cloudscraper, "debug", {
            ...
            enumerable: true,
            set(value) {
                request_promise_1.default.debug = this.debugging = true;
            },
            get() {
    ...
    performRequest(options, isFirstRequest) {
        ...
        request.removeAllListeners("complete").once("complete", (response, body) => {
            this.onRequestResponse(options, null, response, body);
        });
    ...
    onRequestResponse(options, error, response, body) {
        ...
        if (response.isCloudflare && response.isHTML) {
            this.onCloudflareResponse(options, response, body);
        }
        else {
            this.onRequestComplete(options, response, body);
        }
    }
    ...
    validateResponse(options, response, body) {
        // Finding captcha
        // Old version < Dec 2019
    ...
    onChallenge(options, response, body) {
        const callback = options.callback;
    ...
    onCaptcha(options, response, body) {
        ...
        const submit = function (error) {
            ...
            obj.onSubmitCaptcha(options, response);
        };
    ...
    onRedirectChallenge(options, response, body) {
        const callback = options.callback;
        const uri = response.request.uri;
